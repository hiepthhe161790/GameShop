<%-- 
    Document   : Detail
    Created on : Jul 4, 2023, 4:31:49 PM
    Author     : ADMIN
--%>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="${detail.image}" id="current" alt="#">
                                </div>
                                <div class="images">
                                    <img src="${detail.image1}" class="img" alt="#">
                                    <img src="${detail.image2}" class="img" alt="#">
                                    <img src="${detail.image3}" class="img" alt="#">
                                    <img src="${detail.image4}" class="img" alt="#">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i> Genre: <a href="javascript:void(0)">${detail.cateName}</a></p>
                            <h3 class="price">${detail.price} VND</h3>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="info-body">
                                ...
                                <ul class="normal-list">
                                    <li><span>OS: </span> ${detail.OS}</li>
                                    <li><span>Processor: </span> ${detail.processor}</li>
                                    <li><span>Memory: </span> ${detail.memory}(3,000m)</li>
                                    <li><span>Graphics: </span> ${detail.graphics}</li>
                                    <li><span>Storage: </span> ${detail.storage}</li>
                                </ul>
                            </div>
                        </div>
                    </div>
