<%-- 
    Document   : DetailPS
    Created on : Jul 17, 2023, 12:37:16 AM
    Author     : ADMIN
--%>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="${detailps.image}" id="current" alt="#">
                                </div>
                                <div class="images">
                                    <img src="${detailps.image1}" class="img" alt="#">
                                    <img src="${detailps.image2}" class="img" alt="#">
                                    <img src="${detailps.image3}" class="img" alt="#">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            <h2 class="title">${detailps.name}</h2>
                            <h3 class="price">${detailps.price} VND</h3>
                            <p class="info-text">${detailps.description}</p>
