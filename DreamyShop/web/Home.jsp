                            ...
                            <div class="navbar-cart">
                                ...
                                <div class="cart-items">
                                    <a href="javascript:void(0)" class="main-btn">
                                        ...
                                        <span class="total-items">${sessionScope.carts.size()}</span>
                                    </a>
                                    <!-- Shopping Item -->
                                    <div class="shopping-item">
                                            ...
                                            <li>
                                                ...
                                                <div class="cart-img-head">
                                                    <a class="cart-img" href="product-details.html"><img
                                                            src="${C.value.game.imageGame}" alt="#"></a>
                                                </div>

                                                <div class="content">
                                                    <h4><a href="product-details.html">
                                                            ${C.value.game.nameGame}</a></h4>
                                                    <p class="quantity">${C.value.quantity}x-<span class="amount">${C.value.game.price*C.value.quantity}</span></p>
                                                </div>
                                            </li>
                                           </c:forEach>
                                        </ul>
                                        <div class="bottom">
                                            <div class="total">
                                                <span>Total</span>
                                                <span class="total-amount">$${totalMoney}</span>
                                            </div>
                                            <div class="button">
...
<!--                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                    ...
                                    <div class="button">
                                        <a href="add-to-cart?productId=${s.id}" class="btn">BUY</a>
                                    </div>
                                </div>
                            </div>
                            <!-- End Single Slider -->
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        ...
                        <div class="product-image">
                            <img src="${o.image}" alt="#">
                            <div class="button">
                                <a href="add-to-cart?productId=${o.id}" class="btn"><i class="lni lni-cart"></i> BUY</a>
                            </div>
                        </div>
